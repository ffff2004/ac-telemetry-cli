    ...
    TableSpec(
        ...
        (
            ColumnSpec(
                ...
                False,
                "Stable identifier for this per-wheel ABS activity candidate.",
            ),
            ColumnSpec(
                "parent_braking_event_id",
                ColumnAvailability.OPTIONAL,
                False,
                "Identifier of the braking event containing this candidate.",
            ),
            ColumnSpec(
                "session_id",
                ColumnAvailability.OPTIONAL,
                False,
                "Identifier of the session containing the candidate.",
            ),
            ColumnSpec(
                "lap_id",
                ColumnAvailability.OPTIONAL,
                False,
                "Identifier of the lap containing the candidate.",
            ),
            ColumnSpec(
                "event_type",
                ColumnAvailability.OPTIONAL,
                False,
                "Fixed category identifying an ABS intervention candidate.",
            ),
            ColumnSpec(
                "detection_method",
                ColumnAvailability.OPTIONAL,
                False,
                "Versioned spectral detector that produced the candidate.",
            ),
            ColumnSpec(
                "wheel",
                ColumnAvailability.OPTIONAL,
                False,
                "Wheel whose slip signal showed the candidate activity.",
            ),
            ColumnSpec(
                "start_sample",
                ColumnAvailability.OPTIONAL,
                False,
                "Inclusive source-sample index at candidate start.",
            ),
            ColumnSpec(
                "end_sample",
                ColumnAvailability.OPTIONAL,
                False,
                "Inclusive source-sample index at candidate end.",
            ),
            ColumnSpec(
                "start_time_s",
                ColumnAvailability.OPTIONAL,
                False,
                "Lap-relative time in seconds at candidate start.",
            ),
            ColumnSpec(
                "end_time_s",
                ColumnAvailability.OPTIONAL,
                False,
                "Lap-relative time in seconds at candidate end.",
            ),
            ColumnSpec(
                "duration_s",
                ColumnAvailability.OPTIONAL,
                False,
                "Summed sample duration in seconds of the candidate.",
            ),
            ColumnSpec(
                "sample_count",
                ColumnAvailability.OPTIONAL,
                False,
                "Number of inclusive source samples in the candidate.",
            ),
            ColumnSpec(
                "start_track_s_m",
                ColumnAvailability.OPTIONAL,
                True,
                "Track distance in metres at candidate start.",
            ),
            ColumnSpec(
                "end_track_s_m",
                ColumnAvailability.OPTIONAL,
                True,
                "Track distance in metres at candidate end.",
            ),
            ColumnSpec(
                "start_track_progress",
                ColumnAvailability.OPTIONAL,
                True,
                "Normalized track progress at candidate start.",
            ),
            ColumnSpec(
                "end_track_progress",
                ColumnAvailability.OPTIONAL,
                True,
                "Normalized track progress at candidate end.",
            ),
            ColumnSpec(
                "entry_speed_kmh",
                ColumnAvailability.OPTIONAL,
                True,
                "Vehicle speed in km/h at candidate entry.",
            ),
            ColumnSpec(
                "exit_speed_kmh",
                ColumnAvailability.OPTIONAL,
                True,
                "Vehicle speed in km/h at candidate exit.",
            ),
            ColumnSpec(
                "mean_brake",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean normalized brake input during the candidate.",
            ),
            ColumnSpec(
                "peak_brake",
                ColumnAvailability.OPTIONAL,
                True,
                "Maximum normalized brake input during the candidate.",
            ),
            ColumnSpec(
                "mean_wheel_load",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean load of the affected wheel during the candidate.",
            ),
            ColumnSpec(
                "mean_slip_ratio",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean slip ratio of the affected wheel during the candidate.",
            ),
            ColumnSpec(
                "minimum_slip_ratio",
                ColumnAvailability.OPTIONAL,
                True,
                "Minimum slip ratio of the affected wheel during the candidate.",
            ),
            ColumnSpec(
                "detrended_slip_rms",
                ColumnAvailability.OPTIONAL,
                True,
                "Root-mean-square detrended slip ratio during the candidate.",
            ),
            ColumnSpec(
                "observed_peak_frequency_hz",
                ColumnAvailability.OPTIONAL,
                True,
                "Median observed high-band slip peak frequency in Hz.",
            ),
            ColumnSpec(
                "spectral_centroid_hz",
                ColumnAvailability.OPTIONAL,
                True,
                "Median high-band slip spectral centroid in Hz.",
            ),
            ColumnSpec(
                "high_band_power_fraction",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean fraction of slip spectral power in the configured high band.",
            ),
            ColumnSpec(
                "high_to_low_power_ratio",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean ratio of high-band to low-band slip spectral power.",
            ),
            ColumnSpec(
                "high_band_noise_excess_ratio",
                ColumnAvailability.OPTIONAL,
                True,
                "High-band slip RMS relative to the session noise baseline, if available.",
            ),
            ColumnSpec(
                "brake_high_band_power_fraction",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean fraction of brake-input spectral power in the high band.",
            ),
            ColumnSpec(
                "same_axle_high_band_correlation",
                ColumnAvailability.OPTIONAL,
                True,
                "Mean high-band slip correlation with the opposite axle wheel.",
            ),
            ColumnSpec(
                "activity_score",
                ColumnAvailability.OPTIONAL,
                False,
                "Detector score quantifying evidence of ABS-like activity.",
            ),
            ColumnSpec(
                "confidence",
                ColumnAvailability.OPTIONAL,
                False,
                "Activity score adjusted for peak-frequency alias risk.",
            ),
            ColumnSpec(
                "quality_flags",
                ColumnAvailability.OPTIONAL,
                False,
                "Semicolon-delimited caveats about the candidate evidence.",
            ),
        ),
        ("event_id",),
        False,
    ...
    TableSpec(
        ...
        (
            ColumnSpec(
                ...
                ColumnAvailability.REQUIRED,
                False,
                "Stable identifier for this per-wheel traction-control activity candidate.",
            ),
            ColumnSpec(
                "parent_throttle_event_id",
                ColumnAvailability.OPTIONAL,
                False,
                "Identifier of the throttle event containing this candidate.",
            ),
            ColumnSpec(
                "session_id",
                ColumnAvailability.OPTIONAL,
            ...
            ColumnSpec(
                ...
                ColumnAvailability.OPTIONAL,
                False,
                "Fixed category identifying a traction-control intervention candidate.",
            ),
            ColumnSpec(
                "detection_method",
                ColumnAvailability.OPTIONAL,
            ...
            ColumnSpec(
                ...
                ColumnAvailability.OPTIONAL,
                False,
                "Whether the wheel is known driven or the drivetrain is unknown.",
            ),
            ColumnSpec(
                "start_sample",
                ColumnAvailability.OPTIONAL,
            ...
            ColumnSpec(
                ...
                ColumnAvailability.OPTIONAL,
                True,
                "Mean normalized throttle input during the candidate.",
            ),
            ColumnSpec(
                "peak_throttle",
                ColumnAvailability.OPTIONAL,
                True,
                "Maximum normalized throttle input during the candidate.",
            ),
            ColumnSpec(
                "mean_brake",
                ColumnAvailability.OPTIONAL,
            ...
            ColumnSpec(
                ...
                ColumnAvailability.OPTIONAL,
                True,
                "Maximum slip ratio of the affected wheel during the candidate.",
            ),
            ColumnSpec(
                "detrended_slip_rms",
                ColumnAvailability.OPTIONAL,
            ...
            ColumnSpec(
                ...
                ColumnAvailability.OPTIONAL,
                True,
                "Mean fraction of throttle-input spectral power in the high band.",
            ),
            ColumnSpec(
                "same_axle_high_band_correlation",
                ColumnAvailability.OPTIONAL,
            ...
            ColumnSpec(
                ...
                ColumnAvailability.OPTIONAL,
                False,
                "Detector score quantifying evidence of traction-control-like activity.",
            ),
            ColumnSpec(
                "confidence",
                ColumnAvailability.OPTIONAL,
